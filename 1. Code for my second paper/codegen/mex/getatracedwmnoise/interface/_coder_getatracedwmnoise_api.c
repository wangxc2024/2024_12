 ...
 *
 * _coder_getatracedwmnoise_api.c
 *
 * Code generation for function '_coder_getatracedwmnoise_api'
 *
 */

/* Include files */
#include "_coder_getatracedwmnoise_api.h"
...
static emlrtRTEInfo j_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_getatracedwmnoise_api",      /* fName */
  ""                                   /* pName */
};
  ...
  const emlrtMsgIdentifier *msgId))[90]
{
  ...
  void getatracedwmnoise_api(const mxArray * const prhs[6], int32_T nlhs, const
  mxArray *plhs[2])
{
  emxArray_real_T *yy;
  emxArray_real_T *uy;
  ...
  emxInit_real_T(&st, &yy, 2, &j_emlrtRTEI, true);
  emxInit_real_T(&st, &uy, 2, &j_emlrtRTEI, true);
  ...
  noise = emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "noise");
  noiseadd = emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "noiseadd");

  /* Invoke the target function */
  getatracedwmnoise(&st, Tp, *b_y0, &param, *pulse, noise, noiseadd, yy, uy);
...
/* End of code generation (_coder_getatracedwmnoise_api.c) */
