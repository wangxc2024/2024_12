...
/* Include files */
#include "_coder_dSOM_mex_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName", emlrtMxCreateString("dSOM"));
  ...
  emlrtSetField(xEntryPoints, 0, "ResolvedFilePath",
                emlrtMxCreateString("E:\\WXC\\WM\\mat\\dSOM.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739531.52356481482));
  emlrtSetField(xEntryPoints, 0, "Constructor",
                emlrtMxCreateLogicalScalar(false));
  emlrtSetField(xEntryPoints, 0, "Visible", emlrtMxCreateLogicalScalar(true));
  xInputs = emlrtCreateLogicalMatrix(1, 8);
  emlrtSetField(xEntryPoints, 1, "QualifiedName", emlrtMxCreateString("SOMi"));
  ...
  emlrtSetField(xEntryPoints, 1, "ResolvedFilePath",
                emlrtMxCreateString("E:\\WXC\\WM\\mat\\SOMi.m"));
  emlrtSetField(xEntryPoints, 1, "TimeStamp",
                emlrtMxCreateDoubleScalar(739531.52503472217));
...
/* End of code generation (_coder_dSOM_mex_info.c) */
