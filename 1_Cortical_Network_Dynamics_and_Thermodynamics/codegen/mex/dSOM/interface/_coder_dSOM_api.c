 ...
 * _coder_dSOM_api.c
 *
 * Code generation for function '_coder_dSOM_api'
 *
 */
...
static const mxArray *emlrt_marshallOut(real_T u[90]);
...
void dSOM_api(dSOMStackData *SD, const mxArray *const prhs[10],
              const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
  ...
  *plhs = emlrt_marshallOut(*dSom);
}

/* End of code generation (_coder_dSOM_api.c) */
